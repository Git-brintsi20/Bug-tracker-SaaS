...
exports.getSearchSuggestions = exports.searchBugs = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const searchBugs = async (req, res) => {
    try {
        const { organizationId } = req.params;
        const { query, status, priority, assigneeId, reporterId, labelIds, dateFrom, dateTo, page = '1', limit = '50', } = req.query;
        // Build search filter
